...
int main(int argc, char* argv[])
{
    ...
    for (int a = 0; a < to_a; a++)
    {
        ...
        //green_wait_blue = (int*)calloc(threads * 16, sizeof(volatile int));
        //blue_wait_green = (int*)calloc(threads * 16, sizeof(volatile int));
        //memset(green_wait_blue, 0, threads * 16 * sizeof(volatile int));
        //memset(blue_wait_green, 0, threads * 16 * sizeof(volatile int));
        ...
        */
        ...
        free(red);
        free(blue);
        //free(blue_wait_green);
        //free(green_wait_blue);
        free(thread);
