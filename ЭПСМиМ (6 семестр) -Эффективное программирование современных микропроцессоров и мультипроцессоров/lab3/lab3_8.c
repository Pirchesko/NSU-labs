...
int main()
{
    ...
    for (it = 0; it < Nt; it += 8)
    {
        ...
        for (j = 1; j <= Nx - 2; j += 4) // < ?
        {
            mem_v_step(F[(id + 4) % 2], F[(id + 3) % 2], ro[1], v__X_h_x2_h_y2, v__Y_h_x2_h_y2, v__koef_1_5, v__koef_1_4, Nx, Ny, i - 3, j);
        }
        ...
        for (j = 1; j <= Nx - 2; j += 4) // < ?
        {
            mem_v_step(F[(id + 5) % 2], F[(id + 4) % 2], ro[1], v__X_h_x2_h_y2, v__Y_h_x2_h_y2, v__koef_1_5, v__koef_1_4, Nx, Ny, i - 4, j);
        }
        ...
        for (j = 1; j <= Nx - 2; j += 4) // < ?
        {
            mem_v_step(F[(id + 6) % 2], F[(id + 5) % 2], ro[1], v__X_h_x2_h_y2, v__Y_h_x2_h_y2, v__koef_1_5, v__koef_1_4, Nx, Ny, i - 5, j);
        }
        ...
        for (j = 1; j <= Nx - 2; j += 4) // < ?
        {
            mem_v_step(F[(id + 7) % 2], F[(id + 6) % 2], ro[1], v__X_h_x2_h_y2, v__Y_h_x2_h_y2, v__koef_1_5, v__koef_1_4, Nx, Ny, i - 6, j);
        }
        ...
        for (i = 8; i <= Ny - 2; i++) // < ?
        {
            ...
            for (j = 1; j <= Nx - 2; j += 4) // < ?
            {
                mem_v_step(F[(id + 8) % 2], F[(id + 7) % 2], ro[1], v__X_h_x2_h_y2, v__Y_h_x2_h_y2, v__koef_1_5, v__koef_1_4, Nx, Ny, i - 7, j);
            }
        }
        ...
        for (j = 1; j <= Nx - 2; j += 4) // < ?
        {   
            mem_v_step(F[(id + 4) % 2], F[(id + 3) % 2], ro[1], v__X_h_x2_h_y2, v__Y_h_x2_h_y2, v__koef_1_5, v__koef_1_4, Nx, Ny, i - 2, j);
        }
        for (j = 1; j <= Nx - 2; j += 4) // < ?
        {
            mem_v_step(F[(id + 5) % 2], F[(id + 4) % 2], ro[1], v__X_h_x2_h_y2, v__Y_h_x2_h_y2, v__koef_1_5, v__koef_1_4, Nx, Ny, i - 3, j);
        }
        for (j = 1; j <= Nx - 2; j += 4) // < ?
        {
            mem_v_step(F[(id + 6) % 2], F[(id + 5) % 2], ro[1], v__X_h_x2_h_y2, v__Y_h_x2_h_y2, v__koef_1_5, v__koef_1_4, Nx, Ny, i - 4, j);
        }
        for (j = 1; j <= Nx - 2; j += 4) // < ?
        {
            mem_v_step(F[(id + 7) % 2], F[(id + 6) % 2], ro[1], v__X_h_x2_h_y2, v__Y_h_x2_h_y2, v__koef_1_5, v__koef_1_4, Nx, Ny, i - 5, j);
        }
        for (j = 1; j <= Nx - 2; j += 4) // < ?
        {
            mem_v_step(F[(id + 8) % 2], F[(id + 7) % 2], ro[1], v__X_h_x2_h_y2, v__Y_h_x2_h_y2, v__koef_1_5, v__koef_1_4, Nx, Ny, i - 6, j);
        }

        i = Ny - 1;
        for (j = 1; j <= Nx - 2; j += 4) // < ?
        {   
            mem_v_step(F[(id + 4) % 2], F[(id + 3) % 2], ro[1], v__X_h_x2_h_y2, v__Y_h_x2_h_y2, v__koef_1_5, v__koef_1_4, Nx, Ny, i - 1, j);
        }
        for (j = 1; j <= Nx - 2; j += 4) // < ?
        {
            mem_v_step(F[(id + 5) % 2], F[(id + 4) % 2], ro[1], v__X_h_x2_h_y2, v__Y_h_x2_h_y2, v__koef_1_5, v__koef_1_4, Nx, Ny, i - 2, j);
        }
        for (j = 1; j <= Nx - 2; j += 4) // < ?
        {
            mem_v_step(F[(id + 6) % 2], F[(id + 5) % 2], ro[1], v__X_h_x2_h_y2, v__Y_h_x2_h_y2, v__koef_1_5, v__koef_1_4, Nx, Ny, i - 3, j);
        }
        for (j = 1; j <= Nx - 2; j += 4) // < ?
        {
            mem_v_step(F[(id + 7) % 2], F[(id + 6) % 2], ro[1], v__X_h_x2_h_y2, v__Y_h_x2_h_y2, v__koef_1_5, v__koef_1_4, Nx, Ny, i - 4, j);
        }
        for (j = 1; j <= Nx - 2; j += 4) // < ?
        {
            mem_v_step(F[(id + 8) % 2], F[(id + 7) % 2], ro[1], v__X_h_x2_h_y2, v__Y_h_x2_h_y2, v__koef_1_5, v__koef_1_4, Nx, Ny, i - 5, j);
        }

        i = Ny - 1;
        for (j = 1; j <= Nx - 2; j += 4) // < ?
        {
            mem_v_step(F[(id + 5) % 2], F[(id + 4) % 2], ro[1], v__X_h_x2_h_y2, v__Y_h_x2_h_y2, v__koef_1_5, v__koef_1_4, Nx, Ny, i - 1, j);
        }
        for (j = 1; j <= Nx - 2; j += 4) // < ?
        {
            mem_v_step(F[(id + 6) % 2], F[(id + 5) % 2], ro[1], v__X_h_x2_h_y2, v__Y_h_x2_h_y2, v__koef_1_5, v__koef_1_4, Nx, Ny, i - 2, j);
        }
        for (j = 1; j <= Nx - 2; j += 4) // < ?
        {
            mem_v_step(F[(id + 7) % 2], F[(id + 6) % 2], ro[1], v__X_h_x2_h_y2, v__Y_h_x2_h_y2, v__koef_1_5, v__koef_1_4, Nx, Ny, i - 3, j);
        }
        for (j = 1; j <= Nx - 2; j += 4) // < ?
        {
            mem_v_step(F[(id + 8) % 2], F[(id + 7) % 2], ro[1], v__X_h_x2_h_y2, v__Y_h_x2_h_y2, v__koef_1_5, v__koef_1_4, Nx, Ny, i - 4, j);
        }

        i = Ny - 1;
        for (j = 1; j <= Nx - 2; j += 4) // < ?
        {
            mem_v_step(F[(id + 6) % 2], F[(id + 5) % 2], ro[1], v__X_h_x2_h_y2, v__Y_h_x2_h_y2, v__koef_1_5, v__koef_1_4, Nx, Ny, i - 1, j);
        }
        for (j = 1; j <= Nx - 2; j += 4) // < ?
        {
            mem_v_step(F[(id + 7) % 2], F[(id + 6) % 2], ro[1], v__X_h_x2_h_y2, v__Y_h_x2_h_y2, v__koef_1_5, v__koef_1_4, Nx, Ny, i - 2, j);
        }
        for (j = 1; j <= Nx - 2; j += 4) // < ?
        {
            mem_v_step(F[(id + 8) % 2], F[(id + 7) % 2], ro[1], v__X_h_x2_h_y2, v__Y_h_x2_h_y2, v__koef_1_5, v__koef_1_4, Nx, Ny, i - 3, j);
        }

        i = Ny - 1;
        for (j = 1; j <= Nx - 2; j += 4) // < ?
        {
            mem_v_step(F[(id + 7) % 2], F[(id + 6) % 2], ro[1], v__X_h_x2_h_y2, v__Y_h_x2_h_y2, v__koef_1_5, v__koef_1_4, Nx, Ny, i - 1, j);
        }
        for (j = 1; j <= Nx - 2; j += 4) // < ?
        {
            mem_v_step(F[(id + 8) % 2], F[(id + 7) % 2], ro[1], v__X_h_x2_h_y2, v__Y_h_x2_h_y2, v__koef_1_5, v__koef_1_4, Nx, Ny, i - 2, j);
        }

        i = Ny - 1;
        for (j = 1; j <= Nx - 2; j += 4) // < ?
        {
            mem_v_step(F[(id + 8) % 2], F[(id + 7) % 2], ro[1], v__X_h_x2_h_y2, v__Y_h_x2_h_y2, v__koef_1_5, v__koef_1_4, Nx, Ny, i - 1, j);
        }
    ...
    double true_time = time / it * 100;
    //printf("Time: %lf\n", (finish.tv_sec - start.tv_sec + 0.000000001 * (finish.tv_nsec - start.tv_nsec)));
    //printf("delta = %e; Nx = %d, Ny = %d, Nt = %d\n", delta, Nx, Ny, Nt);
    int true_count = count_cells / it * 100;
    printf("Nx = %d, Ny = %d, Nt = %d; it = %d; time = %lf; true time = %lf; total count = %d; true count = %d\n", Nx, Ny, Nt, it, time, true_time, count_cells, true_count);
